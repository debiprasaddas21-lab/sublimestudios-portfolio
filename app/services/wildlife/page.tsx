          ...
          <div className="mt-5 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-3xl text-sm leading-7 text-gray-400 sm:text-base sm:leading-8 md:text-lg">
                Moments of instinct, movement and quiet connection.
                Wildlife photography is about patience, respect and
                observing life as it unfolds in its natural world.
              </p>
